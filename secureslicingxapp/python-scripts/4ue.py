...
class multi_ue(gr.top_block):
    ...
    def __init__(self):
        ...
        self.zeromq_req_source_0_0_1 = zeromq.req_source(gr.sizeof_gr_complex, 1, 'tcp://localhost:2401', 100, False, -1)
        self.zeromq_req_source_0_0_0 = zeromq.req_source(gr.sizeof_gr_complex, 1, 'tcp://localhost:2301', 100, False, -1)
        ...
        self.zeromq_rep_sink_1_1 = zeromq.rep_sink(gr.sizeof_gr_complex, 1, 'tcp://*:2300', 100, False, -1)
        self.zeromq_rep_sink_1_0_0_0 = zeromq.rep_sink(gr.sizeof_gr_complex, 1, 'tcp://*:2500', 100, False, -1)
        self.zeromq_rep_sink_1_0_0 = zeromq.rep_sink(gr.sizeof_gr_complex, 1, 'tcp://*:2400', 100, False, -1)
        ...
        self.blocks_multiply_const_vxx_0_1_0 = blocks.multiply_const_cc(50m)
        self.blocks_multiply_const_vxx_0_0_2 = blocks.multiply_const_cc(40m)
        self.blocks_multiply_const_vxx_0_0_1 = blocks.multiply_const_cc(50m)
        self.blocks_multiply_const_vxx_0_0_0_0_0 = blocks.multiply_const_cc(60m)
        self.blocks_multiply_const_vxx_0_0_0_0 = blocks.multiply_const_cc(40m)
