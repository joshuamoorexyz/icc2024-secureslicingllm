...
class multi_ue(gr.top_block):
    ...
    def __init__(self):
        ...
        self.zeromq_req_source_0_0_1 = zeromq.req_source(gr.sizeof_gr_complex, 1, 'tcp://localhost:2401', 100, False, (-1), False)
        self.zeromq_req_source_0_0_0 = zeromq.req_source(gr.sizeof_gr_complex, 1, 'tcp://localhost:2301', 100, False, (-1), False)
        ...
        self.zeromq_rep_sink_1_1 = zeromq.rep_sink(gr.sizeof_gr_complex, 1, 'tcp://*:2300', 100, False, (-1), True)
        self.zeromq_rep_sink_1_0_0_0 = zeromq.rep_sink(gr.sizeof_gr_complex, 1, 'tcp://*:2500', 100, False, (-1), True)
        self.zeromq_rep_sink_1_0_0 = zeromq.rep_sink(gr.sizeof_gr_complex, 1, 'tcp://*:2400', 100, False, (-1), True)
        ...
        self.blocks_multiply_const_vxx_0_1_0 = blocks.multiply_const_cc(0.050)
        self.blocks_multiply_const_vxx_0_0_2 = blocks.multiply_const_cc(0.040)
        self.blocks_multiply_const_vxx_0_0_1 = blocks.multiply_const_cc(0.050)
        self.blocks_multiply_const_vxx_0_0_0_0_0 = blocks.multiply_const_cc(0.060)
        self.blocks_multiply_const_vxx_0_0_0_0 = blocks.multiply_const_cc(0.040)
        self.blocks_multiply_const_vxx_0_0_0 = blocks.multiply_const_cc(0.080)
        ...
        self.connect((self.blocks_multiply_const_vxx_0_0_0_0_0, 0), (self.zeromq_rep_sink_1_0_0_0, 0))
        self.connect((self.blocks_multiply_const_vxx_0_0_1, 0), (self.blocks_add_xx_0, 2))
        self.connect((self.blocks_multiply_const_vxx_0_0_2, 0), (self.blocks_add_xx_0, 3))
        ...
        self.connect((self.blocks_throttle_0, 0), (self.blocks_multiply_const_vxx_0_0_0_0_0, 0))
        ...
        self.connect((self.zeromq_req_source_0_0_1, 0), (self.blocks_multiply_const_vxx_0_0_2, 0))
